...
test("test Credit/Debit Card (Stripe", async ({ page }) => {
  // ШАГ 1: Открытие главной страницы сайта godlike.hostcommand 'multiclip.copy' not found
...
await expect(cardNumberFrame.locator('input')).toHaveValue('4111111111111111');
