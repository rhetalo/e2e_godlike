...
Реализовано: **~58 тестов**. База (36): Phase 1 (8) + power (3) + console (2) + files (2) + config (2) + players (2) + backups (2) + sharing (5) + Port&Domains (2) + Tasks (2) + role enforcement (3) + security (3). + 07-Jun MCP-сессия (15) + 09-Jun (7: FILE-005/006, SEC-004, AUTH-004, SEC-005, SHR-006, BKP-003).
