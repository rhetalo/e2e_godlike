...
- `agents.docs/game-panel/` — game panel (ultra.panel) knowledge base + test plan (21 tests; Phase 4 Sharing structural+access done, next — invitee multi-actor / Port&Domains)
